...
_$_LearningAnalyticDto _$$_LearningAnalyticDtoFromJson(
    ...
    _$_LearningAnalyticDto(
      ...
      totalCorrectAnswers: json['total_correct_answer'] as int?,
      totalIncorrectAnswers: json['total_incorrect_answer'] as int?,
...
Map<String, dynamic> _$$_LearningAnalyticDtoToJson(
    ...
    <String, dynamic>{
      ...
      'total_correct_answer': instance.totalCorrectAnswers,
      'total_incorrect_answer': instance.totalIncorrectAnswers,
