...
class DraggablePage extends StatefulWidget {
  ...
  /// backgroundColor: The color of the Material widget that underlies the entire DraggablePage body.
  ...
  /// fullyStretchable: Allows toggling of fully expand draggability of the DraggablePage. Set this to true to allow the user to fully expand the header.
  ...
  /// This will create DraggablePage.
  const DraggablePage(
      {Key? key,
      this.leading,
      required this.title,
