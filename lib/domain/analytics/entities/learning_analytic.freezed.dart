...
part of 'learning_analytic.dart';
...
/// @nodoc
abstract class $LearningAnalyticCopyWith<$Res> {
  factory $LearningAnalyticCopyWith(
          LearningAnalytic value, $Res Function(LearningAnalytic) then) =
      _$LearningAnalyticCopyWithImpl<$Res, LearningAnalytic>;
  @useResult
  $Res call(
      {int? id,
      String? userId,
...
/// @nodoc
class _$LearningAnalyticCopyWithImpl<$Res, $Val extends LearningAnalytic>
    implements $LearningAnalyticCopyWith<$Res> {
  _$LearningAnalyticCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_LearningAnalyticCopyWith<$Res>
    implements $LearningAnalyticCopyWith<$Res> {
  factory _$$_LearningAnalyticCopyWith(
          _$_LearningAnalytic value, $Res Function(_$_LearningAnalytic) then) =
      __$$_LearningAnalyticCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? id,
...
/// @nodoc
class __$$_LearningAnalyticCopyWithImpl<$Res>
    extends _$LearningAnalyticCopyWithImpl<$Res, _$_LearningAnalytic>
    implements _$$_LearningAnalyticCopyWith<$Res> {
  __$$_LearningAnalyticCopyWithImpl(
      _$_LearningAnalytic _value, $Res Function(_$_LearningAnalytic) _then)
      : super(_value, _then);
...
class _$_LearningAnalytic implements _LearningAnalytic {
  _$_LearningAnalytic(
      {this.id,
      this.userId,
  ...
  _$$_LearningAnalyticCopyWith<_$_LearningAnalytic> get copyWith =>
      __$$_LearningAnalyticCopyWithImpl<_$_LearningAnalytic>(this, _$identity);
}
